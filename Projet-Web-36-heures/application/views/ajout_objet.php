...
<head>
     ...
     <link rel="stylesheet" href="../assets/css/formulaire-style.css">
     <link rel="stylesheet" href="../../assets/bootstrap/bootstrap-3.3.6-dist/css/bootstrap.css">
     <title> Formulaire ajout objet </title>
</head>
<body>
     <div class="row form-content">
          <h2> Ajouter un objet </h2>
          <form action="" method="post">
               <p> Nom de l'objet : <input type="text" name="nom-produit"> </p>
               <p> Estimation : <input type="number" name="estimation-produit"> </p>
               <p> Description : </p>
