...
<head>
     ...
     <title> Takalo-Takalo - Accueil </title>
</head>
<body>
     <div class="row header-line">
          <div class="col-md-4">
          <a href="<?php echo site_url('login/admin'); ?>"><button id="ba"> Admin </button></a>
          </div>
          <div class="col-md-offset-4 col-md-4">
               <nav class="menu-line">
                    ...
                    <a href="<?php echo site_url('login/inscription'); ?>"> 
                        <button type="button" id="signin">  S'inscrire </button>
                    </a>
               </nav>
          </div>
     </div>
     <div class="row contenu-line">
          <div class="row line-one">
               <h1> Bienvenu(e) sur
                    <span id="deco"> Takalo - Takalo </span>
               </h1>
               <p> Echangez vos objets sans limites </p>
          </div>
          <div class="row line-two">
               <a href="<?php echo site_url('login/user'); ?>">
